...
Community-created video tutorials and external guides for Ship of Harkinian mod development. For self-contained, in-repo walkthroughs of specific tricks, see the [tutorials index](./index.md).
...
- Uses a newer decomp and Jam's Fast64
